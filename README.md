...
[Works](https://clew.kem198.net/works/) ページのライトボックス処理は以下の JavaScript ライブラリを使用している。
...
- [GLightbox](https://biati-digital.github.io/glightbox/)
License: [MIT License](https://biati-digital.github.io/glightbox/#license)
...
- [ピンタレストっぽいMasonryレイアウトをCSSだけで簡易的に実現する \| blog.ojisan.io](https://blog.ojisan.io/masonry-style-css/)
- [Masonry style layout with CSS Grid \| by Andy Barefoot \| Medium](https://medium.com/@andybarefoot/a-masonry-style-layout-using-css-grid-8c663d355ebb)
